...
use crate::nix::{
    Error, INDENT, Output, UsageTracker, maybe_escape_identifier_doc,
    maybe_escape_identifier_string, module_var_name_doc, pattern, syntax,
};
use crate::pretty::{Document, Documentable, break_, join, nil};
use crate::type_::{
    ...
    fn case<'a>(
        ...
        for clause in clauses {
            ...
            for multipatterns in multipatterns {
                ...
                let consequence = r#gen.expression_generator.expression(&clause.then)?;
